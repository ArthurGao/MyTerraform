...
// Identity Cluster
variable "identity_cluster_instance_type" {
  description = "EC2 Instance type for identity cluster instances"
  type        = string
  default     = "t3.small"
}
variable "identity_cluster_min_size" {
  description = "Minimum number of EC2 instances in identity cluster"
  type        = number
  default     = 1
}
variable "identity_cluster_max_size" {
  description = "Maximum number of EC2 instances in identity cluster"
  type        = number
  default     = 4
}

// Gateway ECS Cluster
variable "gateway_cluster_instance_type" {
  description = "EC2 Instance type for gateway cluster instances"
  type        = string
  default     = "t3.micro"
}
variable "gateway_cluster_min_size" {
  description = "Minimum number of EC2 instances in gateway cluster"
  type        = number
  default     = 1
}
variable "gateway_cluster_max_size" {
  description = "Maximum number of EC2 instances in gateway cluster"
  type        = number
  default     = 2
}

// Public ECS Cluster
variable "public_cluster_instance_type" {
  description = "EC2 Instance type for public cluster instances"
  type        = string
  default     = "t3.micro"
}
variable "public_cluster_min_size" {
  description = "Minimum number of EC2 instances in public cluster"
  type        = number
  default     = 1
}
variable "public_cluster_max_size" {
  description = "Maximum number of EC2 instances in public cluster"
  type        = number
  default     = 2
}

// Private ECS Cluster
variable "private_cluster_instance_type" {
  description = "EC2 Instance type for private cluster instances"
  type        = string
  default     = "t3.medium"
}
variable "private_cluster_min_size" {
  description = "Minimum number of EC2 instances in private cluster"
  type        = number
  default     = 1
}
variable "private_cluster_max_size" {
  description = "Maximum number of EC2 instances in private cluster"
  type        = number
  default     = 2
}
